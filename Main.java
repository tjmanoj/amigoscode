...
import amigoscode.email.EmailValidator;
import amigoscode.file.ReadWriteCSV;
...
public class Main
{
	public static void main(String[] args)
	{
		...
		System.out.println(EmailValidator.validate("Manoj@gmail.com"));
		...
		try
		{
			File myFile = ReadWriteCSV.createFile("data.csv");
			ReadWriteCSV.writeToFile(myFile, data);
			ReadWriteCSV.readFromFile(myFile);
		}
		catch(IOException e)
		{
